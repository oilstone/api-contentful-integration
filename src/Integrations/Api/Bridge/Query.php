...
use Oilstone\ApiContentfulIntegration\Query as ContentfulQuery;
use Oilstone\ApiContentfulIntegration\Record;

class Query
{
    protected ContentfulQuery $baseQuery;
     ...
     * Query constructor.
     */
    public function __construct(ContentfulQuery $baseQuery)
    {
        $this->baseQuery = $baseQuery;
    }

    public function getBaseQuery(): ContentfulQuery
    {
